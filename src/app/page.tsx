...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-24">
      <div className="mt-32 flex flex-col align-center place-items-center ">
        <h1 className="text-5xl font-bold">No quiero esperar al 1 de marzo</h1>
        <strong>Ningún dato sensible será compartido en el proceso</strong>
      </div>
